                ...
                allOf(withId(R.id.name),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText.perform(scrollTo(), replaceText("Joe"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.email),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatAutoCompleteTextView.perform(scrollTo(), replaceText("Joem@joem.com"), closeSoftKeyboard());
                ...
                allOf(withId(R.id.password),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        appCompatEditText2.perform(scrollTo(), replaceText("testpass123"), closeSoftKeyboard());
